...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang" width="100%">
    <tr>
        ...
        <td width="57%" align="right">
            <%--添加职务 --%>
            <a href="${pageContext.request.contextPath}/pFindDepartment.action">
...
<form action="${pageContext.request.contextPath}/findPost1.action" method="post">
        ...
        <s:iterator value="#pageBean.data" var="post">
            <tr class="tabtd1">
                ...
                <td width="7%" align="center">
                        <%-- 编辑 --%>
                    <a href="${pageContext.request.contextPath}/getSinglePost.action?postId=${post.postId}"><img
